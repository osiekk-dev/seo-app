...
def generate_content_final(
    ...
    """Generuje kompletny artykuł SEO przez Claude API.

    Args:
        keyword: Fraza główna (lemat).
        competitor_data: Surowy tekst raportów konkurencji.
        grammar_forms: Lista odmian frazy głównej.
        raw_facts: Unikalne fakty i dane od klienta.
        google_sug: Sugestie Google / PAA.
        selected_lsi: Wybrane słowa LSI z analizy.
        manual_lsi: Ręcznie dodane frazy LSI.
        heading_keywords: Dodatkowe słowa do nagłówków.
        brand_name: Nazwa firmy/eksperta.
        num_competitor_files: Liczba wgranych raportów.
        internal_report_content: Zawartość raportu Internal.
        competitor_insights: Wyniki analizy konkurencji.

    Returns:
        Wygenerowany artykuł w formacie Markdown.
    """
...
- Zakaz fraz AI: „Zanurzmy się", „Przyjrzyjmy się", „Bez wątpienia", „Należy podkreślić",
  „Należy wykonać", „Należy zauważyć", „Warto zaznaczyć", „Szczególnie istotne",
  „Jest to", „Są to", „To jest"
...
✓ Czy brak fraz: „Należy wykonać", „Należy zauważyć", „Warto zaznaczyć", „Szczególnie istotne"?
